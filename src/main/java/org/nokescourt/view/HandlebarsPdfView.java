 ...
 * @since 0.1.0
 */
public class HandlebarsPdfView extends AbstractTemplateView {
    ...
    protected void renderMergedTemplateModel(@NonNull final Map<String, Object> model,
        ...
        try {
            ...
            HtmlConverter.convertToPdf(template.apply(context), response.getOutputStream(), converterProperties);
        } finally {
            context.destroy();
        }
